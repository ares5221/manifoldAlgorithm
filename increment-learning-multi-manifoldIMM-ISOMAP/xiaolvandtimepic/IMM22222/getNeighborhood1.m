function [sX,allNeighbor,newDE] = getNeighborhood(X,D1,d,r,maxAngle,newDE)
...
Idone = [currentT]; 
deviation = []; 
newDE(allNeighbor{currentT},currentT) = D1(allNeighbor{currentT},currentT);
newDE(currentT,currentT) = 0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#############
  ...
  [neighbor,U,nSame] = getDNNofOnePoint(currentT,X,D1(:,currentT),d,r,maxAngle,currentP,tangent{currentP},allNeighbor);    
    ...
    newDE(allNeighbor{currentT},currentT) = D1(allNeighbor{currentT},currentT); newDE(currentT,currentT) = 0;
end;
tempX = Idone(lastLocation+1:end); sX= [sX tempX];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
newSX = {};
