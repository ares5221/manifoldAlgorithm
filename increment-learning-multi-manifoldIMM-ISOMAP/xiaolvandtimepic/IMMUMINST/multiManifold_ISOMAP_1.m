function [y,landmarks,newsX,sY,newAllNeighbor,newDE,newDG,newP] = multiManifold_ISOMAP_1(XX,d,r,maxAngle,X1,sX,sY,allNeighbor,DE,DG,P)
    %%list就是ss分块的列表
    ...
    %%%%%%%%%%%%%%%%%%%%%composition process%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [relationPs,relationPs1,Ws1,center,edgePs] = composition(d,newsX, allNeighbor,newDG,newP,newDE,sY);
    %%%4.transformation%%%
    [y,landmarks] = computerNewY(newX,1:219,Ws1,relationPs,relationPs1,newsX,sY,d,newDG,newDE,center,edgePs);
